...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while (!jogo.isJogoEstaTerminado()) {
            ...
            for (int i = 0; i < jogo.getTabuleiro().getAltura(); i++) {
                for (int j = 0; j < jogo.getTabuleiro().getLargura(); j++) {
                    switch (jogo.getTabuleiro().getTipoNa(j, i)) {
                        case VAZIO -> System.out.println(" ");
                        case COMIDA -> System.out.println("\uD83C\uDF4E");
                        case CORPO_COBRA -> System.out.println("■");
                        case CABECA_COBRA -> System.out.println("●");
